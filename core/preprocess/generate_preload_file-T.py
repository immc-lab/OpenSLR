...
def load_info(prefix):
    train_info = load("./phoenix2014-T/train_info.npy").item()
    test_info = load("./phoenix2014-T/test_info.npy").item()
    dev_info = load("./phoenix2014-T/dev_info.npy").item()
...
def main():
    gloss_dict = np.load("./phoenix2014-T/gloss_dict.npy", allow_pickle=True).item()
    train_info_list, test_info_list, dev_info_list = load_info("/sda/home/guozihang/guozihang/PHOENIX-2014-T-release-v3/PHOENIX-2014-T/features/fullFrame-256x256px")
